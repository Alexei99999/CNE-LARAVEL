            ...
            <div>
                ...
                <p class="text-gray-600 mt-1 dark:text-gray-300">
                    ...
                    @elseif(auth()->user()->hasRole('gestor'))
                        Bienvenido, <span class="font-semibold text-primary-600">Gestor</span>. Puedes consultar información y ver reportes, pero no modificar la configuración principal.
                    @else
